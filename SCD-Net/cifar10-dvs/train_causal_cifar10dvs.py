...
def parse_args():
    ...
    parser.add_argument('--output-dir', default='./output/train_causal_cifar10dvs', help='path where to save')
...
def main(args):
    ...
    base_output_dir = args.output_dir if args.output_dir else "./output/train_causal_cifar10dvs"
