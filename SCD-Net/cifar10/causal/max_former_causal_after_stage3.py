...
class Max_Former(nn.Module):
    def __init__(self, in_channels=2, num_classes=11,
        ...
        # 加入因果掩码干预模块：在 stage3 之后、线性分类头之前，通道维度为 embed_dims
        self.causal_mask = DynamicCausalMask(in_channels=embed_dims)
    ...
    def forward_features(self, x):
        ...
        x_full_deep = x
        x_masked_deep, mask_prob = self.causal_mask(x_full_deep)
