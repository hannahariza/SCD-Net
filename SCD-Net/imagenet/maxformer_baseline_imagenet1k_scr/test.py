...
from model.maxformer_baseline.utils import evaluate
...
import model.maxformer_baseline.max_former as max_former
import model.maxformer_baseline.ms_qkformer as ms_qkformer
import wandb
...
def main(args):
    ...
    model = model.maxformer_baseline.misc.load_old_ckpt(model, args.resume, verbose=False)
