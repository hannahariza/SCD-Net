...
from model.maxformer_baseline_tinyimagenet.utils import evaluate
...
import model.maxformer_baseline_tinyimagenet.max_former as max_former
import model.maxformer_baseline_tinyimagenet.ms_qkformer as ms_qkformer
import wandb
...
def main(args):
    ...
    model = model.maxformer_baseline_tinyimagenet.misc.load_old_ckpt(model, args.resume, verbose=False)
