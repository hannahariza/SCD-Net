...
from model.maxformer_baseline_tinyimagenet.utils import *
from model.maxformer_baseline_tinyimagenet.utils import train_one_epoch, evaluate
import model.maxformer_baseline_tinyimagenet.misc as misc
from model.maxformer_baseline_tinyimagenet.misc import NativeScalerWithGradNormCount as NativeScaler
...
from model.maxformer_baseline_tinyimagenet.max_former import maxformer
from model.maxformer_baseline_tinyimagenet.ms_qkformer import ms_qkformer
# import wandb
...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='/root/lanyun-pub/imagenet-1k/data', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--output_dir', default='./outputr',
...
def main(args):
    model.maxformer_baseline_tinyimagenet.misc.init_distributed_mode(args)
    ...
    if args.distributed:
        num_tasks = model.maxformer_baseline_tinyimagenet.misc.get_world_size()
        global_rank = model.maxformer_baseline_tinyimagenet.misc.get_rank()
    ...
    eff_batch_size = args.batch_size * args.accum_iter * model.maxformer_baseline_tinyimagenet.misc.get_world_size()
    ...
    model.maxformer_baseline_tinyimagenet.misc.load_model(args=args, model_without_ddp=model_without_ddp, optimizer=optimizer, loss_scaler=loss_scaler)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and model.maxformer_baseline_tinyimagenet.misc.is_main_process():
            update_summary(
                epoch,
                train_stats,
                test_stats,
