...
from model.maxformer_causal_imagenet100.utils import evaluate
...
import model.maxformer_causal_imagenet100.max_former as max_former
import model.maxformer_causal_imagenet100.ms_qkformer as ms_qkformer
# import wandb
...
def main(args):
    ...
    model = model.maxformer_causal_imagenet100.misc.load_old_ckpt(model, args.resume, verbose=False)
