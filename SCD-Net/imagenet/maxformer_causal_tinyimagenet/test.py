...
from model.maxformer_causal_tiny_imagenet.utils import evaluate
...
import model.maxformer_causal_tiny_imagenet.max_former as max_former
import model.maxformer_causal_tiny_imagenet.ms_qkformer as ms_qkformer
# import wandb
...
def main(args):
    ...
    model = model.maxformer_causal_tiny_imagenet.misc.load_old_ckpt(model, args.resume, verbose=False)
