...
from model.maxformer_causal_tiny_imagenet.utils import *
from model.maxformer_causal_tiny_imagenet.utils import infer_num_classes, is_tiny_imagenet_layout, normalize_dataset_name
from model.maxformer_causal_tiny_imagenet.utils import train_one_epoch, evaluate
import model.maxformer_causal_tiny_imagenet.misc as misc
from model.maxformer_causal_tiny_imagenet.misc import NativeScalerWithGradNormCount as NativeScaler
...
from model.maxformer_causal_tiny_imagenet.max_former import maxformer
from model.maxformer_causal_tiny_imagenet.ms_qkformer import ms_qkformer
# import wandb
...
def main(args):
    model.maxformer_causal_tiny_imagenet.misc.init_distributed_mode(args)
    ...
    if args.distributed:
        num_tasks = model.maxformer_causal_tiny_imagenet.misc.get_world_size()
        global_rank = model.maxformer_causal_tiny_imagenet.misc.get_rank()
    ...
    eff_batch_size = args.batch_size * args.accum_iter * model.maxformer_causal_tiny_imagenet.misc.get_world_size()
    ...
    model.maxformer_causal_tiny_imagenet.misc.load_model(args=args, model_without_ddp=model_without_ddp, optimizer=optimizer, loss_scaler=loss_scaler)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and model.maxformer_causal_tiny_imagenet.misc.is_main_process():
            update_summary(
                epoch,
                train_stats,
                test_stats,
